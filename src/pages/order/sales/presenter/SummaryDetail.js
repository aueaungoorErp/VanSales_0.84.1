...
const SummaryDetail = props => {
  ...
  return <ScrollView style={styles.scrollContainer} contentContainerStyle={styles.scrollContent}>
      {orderType !== 'โอนย้ายสินค้า' ? <View style={styles.summaryCard}>
        ...
        justifyContent: 'flex-end'
          ...
          {userToken && userToken.VANCONFIG && userToken.VANCONFIG.VANCNF_ROUND && userToken.VANCONFIG.VANCNF_ROUND != 0.0 && (printType === 'cash' || printType === 'returnCash') ? <View>
              {VDI_AF_ROUND_V !== null && VDI_AF_ROUND_V !== 0 ? <View style={[styles.lineSection, {
          flexDirection: 'row',
          justifyContent: 'flex-end'
        }]}>
                  <Text style={styles.labelText} allowFontScaling={false}>
            ...
            justifyContent: 'flex-end'
              ...
              {VDI_AF_ROUND !== null && VDI_AF_ROUND !== netPrice ? <View style={[styles.lineSection, {
          flexDirection: 'row',
          justifyContent: 'flex-end'
        }]}>
                  <Text style={styles.labelText} allowFontScaling={false}>
        ...
        <View style={styles.lineSection}>
          ...
          justifyContent: 'flex-end'
            ...
            <Text style={styles.valueText}>
              {processResult ? decimal2digitWithCommas(parseFloat(displayTotalItems || 0)) : decimal2digitWithCommas(totalItems)}
            </Text>
          </Item>
          ...
          justifyContent: 'flex-end'
            ...
            <Text style={styles.valueText}>
              {amountQTY != -1 ? decimal2digitWithCommas(parseFloat(amountQTY)) : decimal2digitWithCommas(totalQty)}
            </Text>
          </Item>
        </View>
        </View>}
