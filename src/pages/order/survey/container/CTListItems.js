      ...
      <ListItem
        title={
          <View style={{ flex: 1, flexDirection: 'row' }}>
            <View style={{ flex: 0.7, alignSelf: 'center' }}></View>

            <View style={{ flex: 0.15 }}>
              <Text>
                {this.props.masterData.SVF.item &&
                this.props.masterData.SVF.item.SVF_ANS_YES
                  ? this.props.masterData.SVF.item.SVF_ANS_YES
                  : null}
              </Text>
            </View>
            ...
            <View style={{ flex: 0.15 }}>
              <Text>
                {this.props.masterData.SVF.item &&
                this.props.masterData.SVF.item.SVF_ANS_YES
                  ? this.props.masterData.SVF.item.SVF_ANS_NO
                  : null}
              </Text>
            </View>
          </View>
        ...
        title={
          <View style={{ flex: 1, flexDirection: 'row' }}>
            ...
            <View style={{ flex: 0.15 }}>
              <CheckBox
                checked={
                  this.props.order.survey.VDI_ANS[index] == 1 ? true : false
                }
                checkedColor={MainTheme.colorPrimary}
                containerStyle={styles.checkBoxStyle}
                onPress={() => {
                  this._setVdiAns(parseInt(item.VDI_ANS_MAP) - 1, 1);
                }}
              />
            </View>
            <View style={{ flex: 0.15 }}>
              <CheckBox
                checked={
                  this.props.order.survey.VDI_ANS[index] === 0 ? true : false
                }
                checkedColor={MainTheme.colorPrimary}
                containerStyle={styles.checkBoxStyle}
                onPress={() => {
                  this._setVdiAns(parseInt(item.VDI_ANS_MAP) - 1, 0);
                }}
              />
            </View>
          </View>
