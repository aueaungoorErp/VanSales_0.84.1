...
class CTForm extends React.Component {
  ...
  _setCreateCheckedItems = async (keyParent, keyChildren, value) => {
    let {
      checkedItems
    } = this.props.outstandingBalance.create;
    let {
      VPH_PAY_AMT
    } = this.props.outstandingBalance.process.header;
  ...
  render() {
    return <Form userToken={this.state.userToken} outstandingBalance={this.props.outstandingBalance} bankFileListItems={this.props.masterData.bankFileListItems} bankAccountListItems={this.props.masterData.bankAccountListItems} checkedItems={this.props.outstandingBalance.create.checkedItems} setCreateCheckedItems={this._setCreateCheckedItems} setCreateCheckedItemsCheque={this._setCreateCheckedItemsCheque} />;
  }
}
