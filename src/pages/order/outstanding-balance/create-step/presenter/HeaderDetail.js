            ...
            <View style={styles.slide1}>
                ...
                <View style={{flexDirection: 'row', justifyContent: 'space-between'}}>
                   ...
                   <Text style={[styles.content,{ fontSize: hp('2%')}]} allowFontScaling={false} >
                    ...
                    <Text style={styles.content}>วันที่ {toBuddhistYear(outstandingBalance.header.VPH_DATE)}</Text>
                </View>
                ...
                <View style={{flexDirection: 'row', justifyContent: 'space-between'}}>
                    ...
                    <Text style={[ styles.content, { color: MainTheme.colorDanger } ]} allowFontScaling={false} >
                        ยอดรวม 
                        {
