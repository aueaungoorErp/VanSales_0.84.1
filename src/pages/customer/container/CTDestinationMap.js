...
class CTMapLine extends React.Component {
  ...
  render() {
    this.markers = [];
    return <DestinationMap region={this.state.region} listItems={this.state.markers} getMapInstance={this._getMapInstance} getMarkersInstance={this._getMarkersInstance} onRegionChangeComplete={this._onRegionChangeComplete} setState={this._setState} skipConfirmDialog={this.state.skipConfirmDialog} errorMessage={this.state.errorMessage} isLoading={this.state.isLoading} onRefresh={this._onRefresh} goToCoordinate={this._goToCoordinate} goToGoogleMaps={this._goToGoogleMaps} customerSkip={this._customerSkip} />;
  }
}
