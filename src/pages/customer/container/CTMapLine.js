...
class CTMapLine extends React.Component {
  ...
  _renderItem = ({
    ...
    return <IPatternCusCoordListItem item={item} index={index} goToCoordinate={this._goToCoordinate} goToGoogleMaps={this._goToGoogleMaps} goToOrder={this._goToOrder} />;
  };
  ...
  render() {
    this.markers = [];
    return <MapLine region={this.state.region} listItems={this.state.markers} getMapInstance={this._getMapInstance} getMarkersInstance={this._getMarkersInstance} onRegionChangeComplete={this._onRegionChangeComplete} renderItem={this._renderItem} setState={this._setState} errorMessage={this.state.errorMessage} isLoading={this.state.isLoading} onRefresh={this._onRefresh} refreshing={this.state.refreshing} />;
  }
}
