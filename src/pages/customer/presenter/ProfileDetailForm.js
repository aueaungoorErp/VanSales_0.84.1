    ...
    flex: 1
      ...
      flex: 1
        ...
        <View style={styles.titleSection}>
          ...
          height: 35,
          alignSelf: 'center'
        }} resizeMode="contain" source={require('../../../images/customer_infomation.png')} />
          <Text style={{
        ...
        <Form>
          ...
          paddingVertical: 5
            ...
            borderBottomWidth: 0
              ...
              {AR_SUMMARY && AR_SUMMARY.ARS_CRE_REMAIN_NPDC ? parseFloat(AR_SUMMARY.ARS_CRE_REMAIN_NPDC).toFixed(2).replace(/\B(?=(\d{3})+(?!\d))/g, ',') + ' ' : null}
              </Text>
            </Item>
          </Item>
        </Form>
