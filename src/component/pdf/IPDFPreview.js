...
class IPDFPreview extends React.Component {
  ...
  render() {
    return <View style={styles.container}>
                <Pdf source={{
        uri: this.props.params.source
      }} onLoadComplete={(numberOfPages, filePath) => {}} onPageChanged={(page, numberOfPages) => {}} onError={error => {}} style={styles.pdf} scale={3.2} initialOffsetX={1200} />
