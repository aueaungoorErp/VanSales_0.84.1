...
export const setInitialState = () => dispatch => {
  return new Promise((resolve, reject) => {
    dispatch({
      type: types.OUTSTANDING_BALANCE_SET_INITIAL_STATE
    });
    resolve();
  });
};
export const setCreateInitialState = () => dispatch => {
  return new Promise((resolve, reject) => {
    dispatch({
      type: types.OUTSTANDING_BALANCE_CREATE_SET_INITIAL_STATE
    });
    resolve();
  });
};
export const setCriteria = criteria => dispatch => {
  return new Promise((resolve, reject) => {
    dispatch({
      type: types.OUTSTANDING_BALANCE_SET_CRITERIA,
      payload: criteria
    });
    resolve();
  });
...
export const setCheckNumber = number => dispatch => {
  return new Promise((resolve, reject) => {
    dispatch({
      type: types.OUTSTANDING_BALANCE_SET_CHECK_NUMBER,
      payload: number
    });
    resolve();
  });
...
export const setPrePocessHeader = data => dispatch => {
  return new Promise((resolve, reject) => {
    dispatch({
      type: types.OUTSTANDING_BALANCE_PRE_PROCESS_SET_HEADER,
      payload: data
    });
    resolve();
  });
...
export const setPrePocessListItems = items => dispatch => {
  return new Promise((resolve, reject) => {
    dispatch({
      type: types.OUTSTANDING_BALANCE_PRE_PROCESS_SET_LIST_ITEMS,
      payload: items
    });
    resolve();
  });
...
export const setCreateCheckedItems = items => dispatch => {
  return new Promise((resolve, reject) => {
    dispatch({
      type: types.OUTSTANDING_BALANCE_CREATE_SET_CHECKED_ITEMS,
      payload: items
    });
    resolve();
  });
...
export const setError = bool => dispatch => {
  dispatch({
    type: types.OUTSTANDING_BALANCE_SET_ERROR,
    payload: bool
  });
};
export const clearListItems = () => dispatch => {
  dispatch({
    type: types.OUTSTANDING_BALANCE_CLEAR_LIST_ITEMS
  });
};
export const setListItems = items => dispatch => {
  return new Promise((resolve, reject) => {
    dispatch({
      type: types.OUTSTANDING_BALANCE_SET_LIST_ITEMS,
      payload: items
    });
    resolve();
  });
...
export const searchList = nextPage => (dispatch, getState) => {
  return new Promise((resolve, reject) => {
    ...
    dispatch({
      type: types.OUTSTANDING_BALANCE_SEARCH_LIST_ITEMS
    });
    const criteria = {
    ...
    searchListApi(criteria).then(v => {
      ...
      if (STATUS === '00') {
        ...
        if (RESULT_DATA && RESULT && RESULT.length > 0) {
          ...
          dispatch({
            type: types.OUTSTANDING_BALANCE_SEARCH_LIST_ITEMS_SUCCESS,
            payload: RESULT
          });
        } else {
          dispatch({
        ...
        dispatch({
          type: types.OUTSTANDING_BALANCE_SEARCH_LIST_ITEMS_FAIL
        });
      }
    }).catch(error => {
      dispatch({
...
export const customerPreProcessPayment = () => (dispatch, getState) => {
  return new Promise((resolve, reject) => {
    ...
    customerPreProcessPaymentApi(data).then(v => {
      ...
      if (STATUS === '00') {
        const items = RESULT_DATA.ITEMS.map(item => ({
          ...item,
          VPD_PAY: item.VPD_PAY.toFixed(2)
        }));
        dispatch({
          type: types.OUTSTANDING_BALANCE_PRE_PROCESS_SUCCESS,
          payload: {
...
export const customerProcessPayment = () => (dispatch, getState) => {
  return new Promise((resolve, reject) => {
    const {
      header,
      listItems
    } = getState().outstandingBalance.preProcess;
    const data = {
      HEADER: header,
      ITEMS: listItems
    };
    customerProcessPaymentApi(data).then(v => {
      ...
      if (STATUS === '00') {
        dispatch({
          type: types.OUTSTANDING_BALANCE_PROCESS_SUCCESS,
          payload: {
            header: RESULT_DATA.HEADER,
            listItems: RESULT_DATA.ITEMS
          }
        });
      } else if (STATUS === '10') {
        reject(ERROR_MESSAGES[0]);
...
export const customerCreatePayment = (forceSubmit, TxUID) => (dispatch, getState) => {
  return new Promise((resolve, reject) => {
    const {
      header,
      listItems
    } = getState().outstandingBalance.process;
    ...
    customerCreatePaymentApi(data).then(v => {
      ...
      if (STATUS === '00') {
        dispatch({
          type: types.OUTSTANDING_BALANCE_CREATE_SUCCESS,
          payload: {
            header: RESULT_DATA.HEADER,
            listItems: RESULT_DATA.ITEMS
          }
