...
import { createDocSurveyApi, createDocVisitApi, orderAttachImageApi, orderAttachMultipleImagesApi, orderCancelApi, orderCreateCashApi, orderFileApi, orderUpdateApi, orderUpdateCashApi, orderUpdateQuotationApi, updateOrderSaleApi } from '../api/order';
import { processOrderItemV3Api } from '../api/product';
import { BPAPUS_FUNCTION_BK_CODE, BPAPUS_FUNCTION_DC_CODE, BPAPUS_FUNCTION_V_CODE, BPAPUS_FUNCTION_WH_CODE } from '../constant/bPlusApi';
import * as types from '../constant/order';
import { convertProductItemFromServerProcess2V3, convertProductItemLastBillToOrderItem, generateItemsProcessedFromServer } from '../utils/Order';
import { getLoginGuID, getUserToken } from '../utils/Token';
import { resolveDocumentDateForCreditTerms, resolveOrderDueDateForSave } from '../utils/customerDueDate';
const getQuotationExpiryMoment = header => {
  const expiryMoment = header?.VDI_EXP_DATE ? moment(header.VDI_EXP_DATE, 'YYYYMMDD', true) : null;
  return expiryMoment?.isValid() ? expiryMoment : moment(header?.VDI_DATE);
};
const getQuotationShipMoment = header => {
  const shipMoment = header?.VDI_SHIP_DATE ? moment(header.VDI_SHIP_DATE, 'YYYYMMDD', true) : null;
  return shipMoment?.isValid() ? shipMoment : moment(header?.VDI_DATE);
};
export const setInitialState = () => dispatch => {
  dispatch({
    type: types.ORDER_SET_INITIAL_STATE
  });
};
export const setIsNotFound = bool => dispatch => {
  dispatch({
    type: types.ORDER_SET_IS_NOT_FOUND,
    payload: bool
  });
};
export const setIsLoading = bool => dispatch => {
  dispatch({
    type: types.ORDER_SET_IS_LOADING,
    payload: bool
  });
};
export const setErrorMessage = value => dispatch => {
  dispatch({
    type: types.ORDER_SET_IS_ERROR_MESSAGE,
    payload: value
  });
};
export const setHeader = data => dispatch => {
  dispatch({
    type: types.ORDER_SET_HEADER,
    payload: data
  });
};
export const setDueDate = value => dispatch => {
  dispatch({
    type: types.ORDER_SET_DUE_DATE,
    payload: value
  });
};
export const addProduct = item => dispatch => {
  return new Promise((resolve, reject) => {
    dispatch({
      type: types.ORDER_ADD_PRODUCT_ITEM,
      payload: item
    });
    resolve();
  });
...
export const addProducts = items => dispatch => {
  return new Promise((resolve, reject) => {
    dispatch({
      type: types.ORDER_ADD_PRODUCT_ITEMS,
      payload: items
    });
    resolve();
  });
...
export const removeProductItem = index => dispatch => {
  dispatch({
    type: types.ORDER_REMOVE_PRODUCT_ITEM,
    payload: index
  });
};
export const removeAllProductItems = () => dispatch => {
  return new Promise((resolve, reject) => {
    dispatch({
      type: types.ORDER_REMOVE_ALL_PRODUCT_ITEMS
    });
    resolve();
  });
};
export const setSwipeCurrent = index => dispatch => {
  dispatch({
    type: types.ORDER_SET_SWIPE_CURENT,
    payload: index
  });
};
export const pushSwipeList = item => dispatch => {
  dispatch({
    type: types.ORDER_PUSH_SWIPE_LIST,
    payload: item
  });
};
export const removeAllSwipeList = () => dispatch => {
  dispatch({
    type: types.ORDER_REMOVE_ALL_SWIPE_LIST
  });
};
export const setOrderVisitVdiVisit = value => dispatch => {
  return new Promise((resolve, reject) => {
    dispatch({
      type: types.ORDER_VISIT_SET_VDI_VISIT,
      payload: value
    });
    resolve();
  });
...
export const setDisBill1AfterDis = value => dispatch => {
  return new Promise((resolve, reject) => {
    dispatch({
      type: types.ORDER_SET_DIS_BILL1_AFTER_DISCOUNT,
      payload: value
    });
    resolve();
  });
...
export const setDisBill2AfterDis = value => dispatch => {
  return new Promise((resolve, reject) => {
    dispatch({
      type: types.ORDER_SET_DIS_BILL2_AFTER_DISCOUNT,
      payload: value
    });
    resolve();
  });
...
export const setDisBill1 = value => dispatch => {
  return new Promise((resolve, reject) => {
    dispatch({
      type: types.ORDER_SET_DIS_BILL1,
      payload: value
    });
    resolve();
  });
...
export const setDisBill2 = value => dispatch => {
  return new Promise((resolve, reject) => {
    dispatch({
      type: types.ORDER_SET_DIS_BILL2,
      payload: value
    });
    resolve();
  });
...
export const setDisCountType1 = value => dispatch => {
  return new Promise((resolve, reject) => {
    dispatch({
      type: types.ORDER_SET_DIS_COUNT_TYPE1,
      payload: value
    });
    resolve();
  });
...
export const setDisCountType2 = value => dispatch => {
  return new Promise((resolve, reject) => {
    dispatch({
      type: types.ORDER_SET_DIS_COUNT_TYPE2,
      payload: value
    });
    resolve();
  });
...
export const setVDIRemark = value => dispatch => {
  return new Promise((resolve, reject) => {
    dispatch({
      type: types.ORDER_SET_VDI_REMARK,
      payload: value
    });
    resolve();
  });
...
export const clearDisBill = () => dispatch => {
  return new Promise((resolve, reject) => {
    dispatch({
      type: types.ORDER_CLEAR_DIS_BILL
    });
    resolve();
  });
};
export const calculateOrderProductSummary = () => dispatch => {
  return new Promise((resolve, reject) => {
    dispatch({
      type: types.ORDER_CALCULATE_PRODUCT_SUMMARY
    });
    resolve();
  });
};
export const calculateOrderProductProcessSummary = () => dispatch => {
  return new Promise((resolve, reject) => {
    dispatch({
      type: types.ORDER_CALCULATE_PRODUCT_PROCESSED_SUMMARY
    });
    resolve();
  });
};
export const calculateOrderNetPriceAfterDiscount = () => dispatch => {
  return new Promise((resolve, reject) => {
    dispatch({
      type: types.ORDER_CALCULATE_NET_PRICE_AFTER_DISCOUNT
    });
    resolve();
  });
};
export const addVisitImageItem = uri => dispatch => {
  return new Promise((resolve, reject) => {
    dispatch({
      type: types.ORDER_ADD_VISIT_IMAGE_ITEM,
      payload: uri
    });
    resolve();
  });
...
export const removeVisitImageItem = index => dispatch => {
  return new Promise((resolve, reject) => {
    dispatch({
      type: types.ORDER_REMOVE_VISIT_IMAGE_ITEM,
      payload: index
    });
    resolve();
  });
...
export const removeAllVisitImageItems = () => dispatch => {
  return new Promise((resolve, reject) => {
    dispatch({
      type: types.ORDER_REMOVE_ALL_VISIT_IMAGE_ITEMS
    });
    resolve();
  });
};
export const addStockImageItem = uri => dispatch => {
  return new Promise((resolve, reject) => {
    dispatch({
      type: types.ORDER_ADD_STOCK_IMAGE_ITEM,
      payload: uri
    });
    resolve();
  });
...
export const removeStockImageItem = index => dispatch => {
  return new Promise((resolve, reject) => {
    dispatch({
      type: types.ORDER_REMOVE_STOCK_IMAGE_ITEM,
      payload: index
    });
    resolve();
  });
...
export const removeAllStockImageItems = () => dispatch => {
  return new Promise((resolve, reject) => {
    dispatch({
      type: types.ORDER_REMOVE_ALL_STOCK_IMAGE_ITEMS
    });
    resolve();
  });
};
export const processOrderSale = (data, order, vanConfig) => (dispatch, getState) => {
  return new Promise(async (resolve, reject) => {
    dispatch({
      type: types.ORDER_PROCESS
    });
    ...
    if (vanConfig.VANCNF_NOV_SKU_BAL == 1) {
      ...
      const requestedQtyByGoodsCode = data.ITEMS.reduce((result, item) => {
        ...
        const requestedQty = (Number.isFinite(saleQty) ? saleQty : 0) + (Number.isFinite(freeQty) ? freeQty : 0);
        if (!goodsCode || !Number.isFinite(requestedQty) || requestedQty <= 0) {
          return result;
        }
        result[goodsCode] = (result[goodsCode] || 0) + requestedQty;
        return result;
      }, {});
      for (const [goodsCode, requestedQty] of Object.entries(requestedQtyByGoodsCode)) {
          ...
          if (ResponseCode == 200) {
            for (let obj of responseData.ShowSkuBalance) {
              if (obj.WL_CODE == WL_CODE) {
                ...
                if (Number.isFinite(currentQty) && currentQty - requestedQty < 0) {
                  isNegative = true;
                  good_inVan_qty = parseFloat(currentQty).toFixed(2).replace(/\B(?=(\d{3})+(?!\d))/g, ',');
                }
              }
            }
          }
    ...
    if (isNegative) {
      ...
      if (order.productListItems) {
        for (let i in order.productListItems) {
          let objData = await convertProductItemFromServerProcess2V3(order.productListItems[i]);
          ImpTrhDetail.push(objData);
        }
      } else {
        for (let i in data.ITEMS) {
          let objData = await convertProductItemFromServerProcess2V3(data.ITEMS[i]);
          ImpTrhDetail.push(objData);
        }
      }
      ...
      } else if (data.PROCESS_DETAIL == 'โอนสินค้า' || data.PROCESS_DETAIL == 'โอนย้ายสินค้า') {
      ...
      await lookupErpV3Api(dataObj1).then(v => {
        ...
        if (ResponseCode == 200) {
          let responseData = JSON.parse(ResponseData);
          VANCNF_BOOK_DT = responseData.Dc000110 ? responseData.Dc000110[0].DT_DOCCODE : null;
      ...
      let SLMN_CODE = null;
      await lookupErpV3Api(dataObj3).then(v => {
        const {
          ResponseData,
          ResponseCode,
          ReasonString
        ...
        if (ResponseCode == 200) {
          let responseData = JSON.parse(ResponseData);
          SLMN_CODE = responseData.SL000130 ? responseData.SL000130[0].SLMN_CODE : null;
        } else {}
      }).catch(err => {});
      let ARD_TDSC_KEYIN = data.DIS_BILL_1 + ',' + data.DIS_BILL_2;
      if (data.PROCESS_DETAIL == 'จองสินค้า' || data.PROCESS_DETAIL == 'ใบเสนอราคา') {
        const quotationExpiryMoment = getQuotationExpiryMoment(order.header);
        const quotationShipMoment = getQuotationShipMoment(order.header);
        param = {
          ErpUpdFunc: [{
            ImpTrhHeader: {
              TRH_ARPRB: vanConfig.VANCNF_ARPRB,
              DI_DATE: moment(order.header.VDI_DATE).format('YYYYMMDD'),
              DI_REF: '<เลขถัดไป>',
              DT_DOCCODE: VANCNF_BOOK_DT,
              DT_PROPERTIES: DT_PROPERTIES,
              VAT_DATE: moment(order.header.VDI_DATE).format('YYYYMMDD'),
              VAT_REF: '<เลขเดียวกัน>',
              VAT_RATE: vanConfig.VANCNF_VAT_RATE,
              VAT_RFR_REF: '<เลขเดียวกัน>',
              //TRH_SHIP_DATE: moment('23/12/2023').format('YYYYMMDD'),

              //TRH_SHIP_DATE: moment('20231201').format('YYYYMMDD'),

              TRH_SHIP_DATE: data.PROCESS_DETAIL == 'ใบเสนอราคา' ? quotationShipMoment.format('YYYYMMDD') : moment(order.header.VDI_SHIP_DATE).format('YYYYMMDD'),
              ...(data.PROCESS_DETAIL == 'จองสินค้า' || data.PROCESS_DETAIL == 'ใบเสนอราคา' ? {
                TRH_CANCEL_DATE: quotationExpiryMoment.format('YYYYMMDD')
              } : {}),
              SLMN_CODE: SLMN_CODE,
              AR_CODE: order.header.AR_CODE,
              ARPRB_CODE: customer.item.ARPRB.ARPRB_CODE,
              AROE_TDSC_KEYIN: ARD_TDSC_KEYIN,
              AROE_DUE_DA: data.PROCESS_DETAIL == 'จองสินค้า' || data.PROCESS_DETAIL == 'ใบเสนอราคา' ? quotationExpiryMoment.format('YYYYMMDD') : moment(moment(order.header.VDI_DATE).add(3, 'months')).format('YYYYMMDD')
            },
        ...
        param = {
          ErpUpdFunc: [{
            ImpTrhHeader: {
              ...
              VAT_RATE: vanConfig.VANCNF_VAT_RATE,
              VAT_RFR_REF: '<เลขเดียวกัน>',
              TRH_SHIP_DATE: moment(order.header.VDI_DATE).format('YYYYMMDD'),
              SLMN_CODE: SLMN_CODE,
              AR_CODE: order.header.AR_CODE,
              ARPRB_CODE: customer.item.ARPRB.ARPRB_CODE,
      ...
      if (data.PROCESS_TYPE == 1) {
        ...
        processOrderItemV3Api(dataObj).then(v => {
          ...
          if (ResponseCode == 200) {
            ...
            // });
            let x = generateItemsProcessedFromServer(responseData.TRANSTKD, order.productListItems);
            let itemsPrt = [];
            for (let obj of x) {
              if (obj.TRD_Q_FREE > 0) {
                itemsPrt.push({
...
export const createOrderSaleV3 = (data, V3GUID, vanConfig, paymentType) => (dispatch, getState) => {
  return new Promise(async (resolve, reject) => {
    ...
    let dataObj4 = {
      ...
      'BPAPUS-PARAM': '{"AR_KEY":"' + order.header.VDI_KEY + '","ARCD_DATE":"' + resolveDocumentDateForCreditTerms(order.header) + '","ARCD_DEFAULT":"Y"}',
      'BPAPUS-FILTER': '',
      'BPAPUS-ORDERBY': '',
      'BPAPUS-OFFSET': '0',
      'BPAPUS-FETCH': '0'
    ...
    let ARCD_KEY = null;
    await readErpV3Api(dataObj4).then(v => {
      const {
        ResponseData,
        ResponseCode,
        ReasonString
      ...
      if (ResponseCode == 200) {
        let responseData = JSON.parse(ResponseData);
        ARCD_KEY = responseData.READARCDBYARKEY ? responseData.READARCDBYARKEY[0].ARCD_KEY : null;
      } else {}
    }).catch(err => {});
    let ARD_TDSC_KEYIN = '';
    if (order.orderProductSummary.DIS_COUNT_TYPE2) {
      ...
      //ส่วนลดเปอร์เซ็น
      if (order.orderProductSummary.DIS_BILL_1 || order.orderProductSummary.DIS_BILL_2) {
        if (order.orderProductSummary.DIS_BILL_1 && order.orderProductSummary.DIS_BILL_2) {
          ARD_TDSC_KEYIN = order.orderProductSummary.DIS_BILL_1 + ',' + order.orderProductSummary.DIS_BILL_2;
        } else {
          ARD_TDSC_KEYIN = (order.orderProductSummary.DIS_BILL_1 ? order.orderProductSummary.DIS_BILL_1 : '0') + ',' + (order.orderProductSummary.DIS_BILL_2 ? order.orderProductSummary.DIS_BILL_2 : '0');
        }
      }
    }
    const quotationExpiryMoment = getQuotationExpiryMoment(order.header);
...
export const updateOrderSale = data => (dispatch, getState) => {
  return new Promise((resolve, reject) => {
    ...
    updateOrderSaleApi(data).then(v => {
      const {
        RESULT_DATA,
        STATUS,
        ERROR_MESSAGES
...
export const orderReservV3 = (data, V3GUID, vanConfig) => (dispatch, getState) => {
  return new Promise(async (resolve, reject) => {
    dispatch({
      type: types.ORDER_CREATE
    });
    ...
    if (order.orderProductSummary.DIS_COUNT_TYPE2) {
      ...
      if (order.orderProductSummary.DIS_BILL_1 || order.orderProductSummary.DIS_BILL_2) {
        if (order.orderProductSummary.DIS_BILL_1 && order.orderProductSummary.DIS_BILL_2) {
          AROE_TDSC_KEYIN = order.orderProductSummary.DIS_BILL_1 + ',' + order.orderProductSummary.DIS_BILL_2;
        } else {
          AROE_TDSC_KEYIN = (order.orderProductSummary.DIS_BILL_1 ? order.orderProductSummary.DIS_BILL_1 : '0') + ',' + (order.orderProductSummary.DIS_BILL_2 ? order.orderProductSummary.DIS_BILL_2 : '0');
        }
      }
    }
...
export const orderTransferV3 = (data, V3GUID, vanConfig) => (dispatch, getState) => {
  return new Promise(async (resolve, reject) => {
    const order = getState().order;
    dispatch({
      type: types.ORDER_CREATE
    ...
    for (let i in data.ITEMS) {
      let newObj = {
        KEY: '',
        TRD_DSC_KEYIN: data.ITEMS[i].VTRD_U_DISC_TEXT ? JSON.stringify(data.ITEMS[i].VTRD_U_DISC_TEXT) : data.ITEMS[i].TRD_DSC_KEYIN + '*' + (data.ITEMS[i].VTRD_QTY ? parseFloat(data.ITEMS[i].VTRD_QTY).toFixed(2) : data.ITEMS[i].TRD_QTY) + 'B' ? data.ITEMS[i].TRD_DSC_KEYIN + '*' + (data.ITEMS[i].VTRD_QTY ? parseFloat(data.ITEMS[i].VTRD_QTY).toFixed(2) : data.ITEMS[i].TRD_QTY) + 'B' : '',
        TRD_DSC_KEYINV: data.ITEMS[i].VTRD_U_DSC ? parseFloat(JSON.stringify(data.ITEMS[i].VTRD_U_DSC)).toFixed(2) : parseFloat(data.ITEMS[i].TRD_DSC_KEYINV).toFixed(2) ? parseFloat(data.ITEMS[i].TRD_DSC_KEYINV).toFixed(2) : '',
        TRD_Q_FREE: data.ITEMS[i].VTRD_Q_FREE ? parseFloat(JSON.stringify(data.ITEMS[i].VTRD_Q_FREE)).toFixed(2) : data.ITEMS[i].TRD_Q_FREE ? data.ITEMS[i].TRD_Q_FREE : '',
        TRD_OPTION: '',
        TRD_KEYIN: data.ITEMS[i].VTRD_CODE ? data.ITEMS[i].VTRD_CODE : data.ITEMS[i].TRD_KEYIN ? data.ITEMS[i].TRD_KEYIN : '',
        SKU_NAME: data.ITEMS[i].VTRD_NAMES ? data.ITEMS[i].VTRD_NAMES : data.ITEMS[i].TRD_SH_NAME,
        UTQ_NAME: data.ITEMS[i].VTRD_UTQ_NAME ? data.ITEMS[i].VTRD_UTQ_NAME : data.ITEMS[i].TRD_UTQNAME,
        TRD_QTY: data.ITEMS[i].VTRD_QTY ? parseFloat(data.ITEMS[i].VTRD_QTY).toFixed(2) : data.ITEMS[i].TRD_QTY,
        X_MODEL: 7,
        TRD_WL: transferFromWarehouse,
        TRD_TO_WL: transferToWarehouse,
        TRD_K_U_PRC: data.ITEMS[i].VTRD_U_PRC ? parseFloat(data.ITEMS[i].VTRD_U_PRC).toFixed(2) : data.ITEMS[i].TRD_K_U_PRC,
        // toWarehouse: true,
        // TRD_U_VATIO: undefined,
        AMOUNT: parseFloat(data.ITEMS[i].VTRD_AF_VALUES ?? data.ITEMS[i].TRD_G_AMT ?? 0).toFixed(2),
...
export const orderReturn = (data, type, vanConfig, V3GUID) => (dispatch, getState) => {
  return new Promise(async (resolve, reject) => {
    const order = getState().order;
    const customer = getState().customer;
    dispatch({
    ...
    let dataObj4 = {
      ...
      'BPAPUS-LOGIN-GUID': V3GUID,
      'BPAPUS-FUNCTION': 'READARCDBYARKEY',
      'BPAPUS-PARAM': '{"AR_KEY":"' + order.header.VDI_KEY + '","ARCD_DATE":"' + resolveDocumentDateForCreditTerms(order.header) + '","ARCD_DEFAULT":""}',
      'BPAPUS-FILTER': '',
      'BPAPUS-ORDERBY': '',
      'BPAPUS-OFFSET': '0',
      'BPAPUS-FETCH': '0'
    ...
    if (type === '0') {
      order.header.VDI_USER_REF === null ? api = updateErpV3Api(dataObj) : api = updateErpV3Api(dataObj);
    } else {
      order.header.VDI_USER_REF === null ? api = updateErpV3Api(dataObj) : api = updateErpV3Api(dataObj);
    }
    api.then(v => {
...
export const getProductListItemsFromLastBillByArCode = (V3GUID, vancnf_machine, goodsCodes) => (dispatch, getState) => {
  return new Promise(async (resolve, reject) => {
    const customer = getState().customer;
    const order = getState().order;
    const {
    ...
    dispatch({
      type: types.ORDER_GET_PRODUCT_LIST_FROM_LAST_BILL_BY_AR_CODE
    });
    ...
    if (order.header.AR_ORDER_TYPE === 'จองสินค้า') {
      let dataObj1 = {
        ...
        'BPAPUS-PARAM': '',
        'BPAPUS-FILTER': "and AR_CODE = '" + customer.item.INFO.AR_CODE + "' and  DT_KEY = '" + VANCONFIG.VANCNF_BOOK_DT + "'",
      ...
      let dataObj1 = {
        ...
        'BPAPUS-PARAM': '',
        'BPAPUS-FILTER': "and AR_CODE = '" + customer.item.INFO.AR_CODE + "' and  (DT_KEY = '" + VANCONFIG.VANCNF_INV_DT + "' OR DT_KEY = '" + VANCONFIG.VANCNF_CASHSALES_DT + "')",
        'BPAPUS-ORDERBY': 'order by DI_KEY desc',
        'BPAPUS-OFFSET': '0',
        'BPAPUS-FETCH': '1'
      };
      ...
      let dataObj1 = {
        ...
        'BPAPUS-FUNCTION': BPAPUS_FUNCTION_BK_CODE,
        'BPAPUS-PARAM': '',
        'BPAPUS-FILTER': "and AR_CODE = '" + customer.item.INFO.AR_CODE + "' and  DT_KEY = '" + VANCONFIG.VANCNF_QUOTE_DT + "'",
        'BPAPUS-ORDERBY': 'order by DI_KEY desc',
        'BPAPUS-OFFSET': '0',
        'BPAPUS-FETCH': '1'
      };
    ...
    if (order.header.AR_ORDER_TYPE !== 'ตรวจนับสินค้า') {
      api.then(async v => {
        ...
        if (ResponseCode == 200 && (responseData1.Oe000304?.length > 0 || responseData1.Oe002304?.length > 0)) {
          let dataObj1 = null;
          let DI_REF = null;
          if (order.header.AR_ORDER_TYPE === 'ขายสินค้า') {
            dataObj1 = {
              ...
              'BPAPUS-LOGIN-GUID': V3GUID,
              'BPAPUS-FUNCTION': 'GetInvoiceDocinfo',
              'BPAPUS-PARAM': '{"DI_KEY": "' + responseData1.Oe000304[0].DI_KEY + '"}',
              'BPAPUS-FILTER': '',
              'BPAPUS-ORDERBY': '',
              'BPAPUS-OFFSET': '0',
              'BPAPUS-FETCH': '0'
            ...
            dataObj1 = {
              ...
              'BPAPUS-LOGIN-GUID': V3GUID,
              'BPAPUS-FUNCTION': 'GetSellOrderDocinfo',
              'BPAPUS-PARAM': '{"DI_KEY": "' + responseData1.Oe002304[0].DI_KEY + '"}',
              'BPAPUS-FILTER': '',
              'BPAPUS-ORDERBY': '',
              'BPAPUS-OFFSET': '0',
              'BPAPUS-FETCH': '0'
          ...
          await lookupErpV3Api(dataObj2).then(g => {
            ...
            if (ResponseCode == 200) {
              ...
              WL_CODE = responseDataObj2.Wh000220 ? responseDataObj2.Wh000220[0].WL_CODE : null;
            }
          });
          ...
          TRANSTKD.then(v => {
            ...
            if (ResponseCode == 200) {
              ...
              dispatch({
                type: types.ORDER_GET_PRODUCT_LIST_FROM_LAST_BILL_BY_AR_CODE_SUCCESS
              });
              const filteredTranstkd = Array.isArray(goodsCodes) ? responseData.TRANSTKD.filter(item => goodsCodes.includes(item.GOODS_CODE)) : responseData.TRANSTKD;
              let responseBazz = [];
              let good_inVan = 0;
              for (let obj of filteredTranstkd) {
                good_inVan = getWareLocationStockBalance(obj.GOODS_CODE, VANCONFIG).then(v2 => {
                  const {
                    ReasonString,
                    ResponseCode,
                    ResponseData
                ...
                responseBazz.push({
                  ...obj,
                  good_inVan_qty: good_inVan
                });
              }
              dispatch({
                type: types.ORDER_SET_ITEMS,
                payload: convertProductItemLastBillToOrderItem(responseBazz
...
export const orderCreateCash = data => dispatch => {
  return new Promise((resolve, reject) => {
    ...
    orderCreateCashApi(data).then(v => {
      const {
        RESULT_DATA,
        STATUS,
        ERROR_MESSAGES
...
export const orderUpdateCash = data => dispatch => {
  return new Promise((resolve, reject) => {
    ...
    orderUpdateCashApi(data).then(v => {
      const {
        RESULT_DATA,
        STATUS,
        ERROR_MESSAGES
...
export const createDocSurvey = data => dispatch => {
  return new Promise((resolve, reject) => {
    createDocSurveyApi(data).then(v => {
      const {
        RESULT_DATA,
        STATUS,
        ERROR_MESSAGES
      } = v;
      if (STATUS === '00') {} else if (STATUS === '10') {
        dispatch({
          type: types.ORDER_CREATE_FAIL,
          payload: ERROR_MESSAGES
        });
...
export const orderUpdate = (id, type) => (dispatch, getState) => {
  return new Promise((resolve, reject) => {
    ...
    orderUpdateApi(customer.item.INFO.AR_CODE, id).then(v => {
      const {
        RESULT_DATA,
        STATUS,
        ERROR_MESSAGES
...
export const createQuotation = (data, V3GUID, vanConfig) => (dispatch, getState) => {
  return new Promise(async (resolve, reject) => {
    const order = getState().order;
    const customer = getState().customer;
    let dataObj1 = {
    ...
    let param = {
      ErpUpdFunc: [{
        ImpTrhHeader: {
          ...
          VAT_RATE: vanConfig.VANCNF_VAT_RATE,
          VAT_RFR_REF: '<เลขเดียวกัน>',
          TRH_SHIP_DATE: quotationShipMoment.format('YYYYMMDD'),
          TRH_CANCEL_DATE: quotationExpiryMoment.format('YYYYMMDD'),
          SLMN_CODE: SLMN_CODE,
          AR_CODE: order.header.AR_CODE,
          ARPRB_CODE: customer.item.ARPRB.ARPRB_CODE,
          ...
          //ข้อตกลงเจ้าหนี้
          AROE_TDSC_KEYIN: ARD_TDSC_KEYIN,
          AROE_DUE_DA: quotationExpiryMoment.format('YYYYMMDD'),
          DI_REMARK: order.header.VDI_REMARK
        },
        ImpTrhDetail: ImpTrhDetail,
        ImpTranPayd: [
...
export const orderUpdateQuotation = data => (dispatch, getState) => {
  return new Promise((resolve, reject) => {
    orderUpdateQuotationApi(data).then(v => {
      const {
        RESULT_DATA,
        STATUS,
        ERROR_MESSAGES
...
export const orderAttachImage = data => dispatch => {
  return new Promise((resolve, reject) => {
    orderAttachImageApi(data).then(v => {
      const {
        RESULT_DATA,
        STATUS,
        ERROR_MESSAGES
...
export const orderAttachMultipleImages = data => dispatch => {
  return new Promise((resolve, reject) => {
    orderAttachMultipleImagesApi(data).then(v => {
      const {
        RESULT_DATA,
        STATUS,
        ERROR_MESSAGES
