...
public class MapUtil {
    ...
    public static WritableMap toWritableMap(String key, String value) {
        WritableMap writableMap = Arguments.createMap();
    ...
    public static WritableMap toWritableMap(String key, boolean value) {
        WritableMap writableMap = Arguments.createMap();
        writableMap.putBoolean((String) key,  value);
