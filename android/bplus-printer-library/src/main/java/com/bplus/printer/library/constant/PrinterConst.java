package com.bplus.printer.library.constant;
...
public class PrinterConst {
    ...
    public static final int BARIGAN = 4;

    public static final int[] PRINTER_MODEL_ID_ARRAY = new int[] { ZIJIANG, EPSON, BARIGAN };
    public static final String[] PRINTER_MODEL_NAME_ARRAY = new String[] { "ZIJIANG", "EPSON", "BARIGAN" };
